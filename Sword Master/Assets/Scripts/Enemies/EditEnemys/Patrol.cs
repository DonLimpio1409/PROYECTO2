...
public class Patrol : TemplateStateMachineEnemies
{
    ...
    {
        //Mover
        _fsm.transform.position = Vector3.MoveTowards(_fsm.origin.transform.position, target.wayPointPosition, _fsm.walkSpeed * Time.deltaTime);
    ...
    {
        //Rectos
        Vector3 RayDirectionForward = _fsm.origin.transform.TransformDirection(0, 0, -1f);
        Vector3 RayDirectionBackward = _fsm.origin.transform.TransformDirection(0, 0, 1f);
        Vector3 RayDirectionRight = _fsm.origin.transform.TransformDirection(1f, 0, 0);
        Vector3 RayDirectionLeft = _fsm.origin.transform.TransformDirection(-1f, 0, 0);

        //Diagonales
        Vector3 RayDirectionLeftFD = _fsm.origin.transform.TransformDirection(1f, 0, -1f);
        Vector3 RayDirectionRightBD = _fsm.origin.transform.TransformDirection(-1f, 0, 1f);
        Vector3 RayDirectionRightFD = _fsm.origin.transform.TransformDirection(-1f, 0, -1f);
        Vector3 RayDirectionLeftBD = _fsm.origin.transform.TransformDirection(1f, 0, 1f);

        _fsm.rayDetectorForward = new Ray(_fsm.origin.transform.position, RayDirectionForward);
        Debug.DrawRay(_fsm.origin.transform.position, RayDirectionForward * _fsm.raysLength, Color.red);
        ...
        _fsm.rayDetectorBackward = new Ray(_fsm.origin.transform.position, RayDirectionBackward);
        Debug.DrawRay(_fsm.origin.transform.position, RayDirectionBackward * _fsm.raysLength, Color.red);
        ...
        _fsm.rayDetectorRight = new Ray(_fsm.origin.transform.position, RayDirectionRight);
        Debug.DrawRay(_fsm.origin.transform.position, RayDirectionRight * _fsm.raysLength, Color.red);
        ...
        _fsm.rayDetectorLeft = new Ray(_fsm.origin.transform.position, RayDirectionLeft);
        Debug.DrawRay(_fsm.origin.transform.position, RayDirectionLeft * _fsm.raysLength, Color.red);
        ...
        _fsm.rayDetectorLeftFD = new Ray(_fsm.origin.transform.position, RayDirectionLeftFD);
        Debug.DrawRay(_fsm.origin.transform.position, RayDirectionLeftFD * _fsm.raysLength, Color.red);
        ...
        _fsm.rayDetectorRightBD = new Ray(_fsm.origin.transform.position, RayDirectionRightBD);
        Debug.DrawRay(_fsm.origin.transform.position, RayDirectionRightBD * _fsm.raysLength, Color.red);
        ...
        _fsm.rayDetectorRightFD = new Ray(_fsm.origin.transform.position, RayDirectionRightFD);
        Debug.DrawRay(_fsm.origin.transform.position, RayDirectionRightFD * _fsm.raysLength, Color.red);
        ...
        _fsm.rayDetectorLeftBD = new Ray(_fsm.origin.transform.position, RayDirectionLeftBD);
        Debug.DrawRay(_fsm.origin.transform.position, RayDirectionLeftBD * _fsm.raysLength, Color.red);
